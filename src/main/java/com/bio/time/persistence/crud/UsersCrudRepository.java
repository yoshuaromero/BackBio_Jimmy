...
public interface UsersCrudRepository extends CrudRepository<UsersEntity, Integer> {
    ...
    @Query(value = "select u.id as id_user, u.name, u.lastName, u.email, u.cellphone, u.username, u.password, " +
            "u.visual_disability as visualDisability, u.id_profile as idProfile, u.id_status as id_status, " +
            "u.created_date as createdDate, u.id_payment_method as idPaymentMethod, p.description " +
            "from users u" +
