...
import DialogInfo from '@/components/inscription-modifies/CampaignInfo/DialogInfo.vue'
import DialogForm from '@/components/inscription-modifies/CampaignInfo/DialogForm.vue'
...
const getCampaignInfo = async () => {
  ...
  try {
    ...
    const { data } = await axios.get(`/v1/campaign/get-campaign-information-e7/${props.inscriptionId}`)
...
const handleSubmit = async value => {
  try {
    ...
    const requestBody = {
      "inscriptionId": value.form.value.inscriptionIdE6 || toRefs(props).inscriptionIdE6.value,
      ...
      "phase":"E7",
      "inscriptionChangeId": value.form.value.inscriptionChangeId,
...
<template>
  <div>
    ...
    <DialogForm
      ...
      :inscription-id="inscriptionIdE6" 
      :inscription-modify-id="inscriptionId"
    ...
    <VCard>
      <VRow>
        ...
        <VCol class="v-col-sm-6 px-12 py-12 text-end">
          <VBtn
            v-if="!readonly && can('post', 'campaign-information')"
