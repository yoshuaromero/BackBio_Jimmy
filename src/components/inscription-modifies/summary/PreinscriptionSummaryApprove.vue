...
import DownloadE7 from './DownloadE7.vue'
...
import DownloadE7Physical from "./DownloadE7Physical.vue"
import RegenerateE7 from "./RegenerateE7.vue"
          ...
          <VRow>
            ...
            >
              ...
              <VRow class="match-height">
                <VCol cols="12">
                  <DownloadE7 class="mb-2" :inscription-id="inscriptionId" />
                  <RegenerateE7
                    v-if="can('regenerate-approved-document', 'inscription-change')"
                    class="mt-2"
                    :inscription-id="inscriptionId" 
                    :radicate="radicate"
                  />

                  <DownloadE7Physical class="mt-2" :inscription-id="inscriptionId" />
                </VCol>
              </VRow>
            </VCol>
          </VRow>
