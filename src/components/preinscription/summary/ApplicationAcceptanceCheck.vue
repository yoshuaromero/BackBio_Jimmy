...
const { t } = useI18n()
const listApplicationAcceptanceCheck = ref(`/v1/inscriptions/list/${props.inscriptionId}`)
...
const handlerApplicationAcceptance = async (candidateDni, inscriptionId, candidateId, value) => {
              ...
              <div class="d-flex justify-center">
                <div>
                  <VRadioGroup 
                    ...
                    @update:model-value="$event => handlerApplicationAcceptance(item.candidateDni, item.inscriptionId, item.candidateId, $event)"
                  >
