...
const informationCandidate = async () => {
  try {
    ...
    const { data }  = await axios.get(`/grouping-political/inscription?inscriptionId=${props.inscriptionId}&groupId=${props.groupingPoliticalTypeId}`)
