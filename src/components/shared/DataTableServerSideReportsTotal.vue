...
export default {
  ...
  setup(props) {
    ...
    const rowsTotals = computed(() => itemsTotals.value)
    ...
    const getData = async payload => {
      ...
      try {
        ...
        const { content,totals, ...result } = data

        itemsTotals.value = totals
        items.value = content
        ...
        <tr>
          ...
          <th>
            <div class="d-flex justify-center">
              {{ rowsTotals.totalRegisteredCandidates }}
            </div>
          </th>
          <th>
            <div class="d-flex justify-center">
              {{ rowsTotals.totalCandidatesAccepted }}
            </div>
          </th>
          <th>
            <div class="d-flex justify-center">
              {{ rowsTotals.totalAcceptanceLetters }}
            </div>
          </th>
          <th>
            <div class="d-flex justify-center">
              {{ rowsTotals.totalCandidatesRejected }}
            </div>
          </th>
          <th>
            <div class="d-flex justify-center">
              {{ rowsTotals.totalRejectionLetters }}
            </div>
          </th>
          <th>
            <div class="d-flex justify-center">
              {{ rowsTotals.totalAcceptanceEIS }}
            </div>
          </th>
          <th>
            <div class="d-flex justify-center">
              {{ rowsTotals.totalAcceptanceFacial }}
            </div>
          </th>
        </tr>
      </tfoot>
